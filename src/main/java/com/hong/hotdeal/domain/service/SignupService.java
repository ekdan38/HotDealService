...
import com.hong.hotdeal.domain.repository.UserRepository;
    ...
    public Long signup(SignupRequestDto requestDto) {
        ...
        try {
            User user = User.create(
                    aesUtil.encrypt(requestDto.getUsername(), secretKey),
                    passwordEncoder.encode(requestDto.getPassword()),
                    aesUtil.encrypt(requestDto.getName(), secretKey),
                    aesUtil.encrypt(requestDto.getPhoneNumber(), secretKey),
                    aesUtil.encrypt(requestDto.getAddress(), secretKey),
                    aesUtil.encrypt(requestDto.getEmail(), secretKey),
                    Role.USER
            );
            // User 저장
