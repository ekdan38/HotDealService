...
public class Outbox extends TimeEntity {
    ...
    private Outbox(AggregateType aggregateType, Long aggregateId, EventType eventType, OutboxDeliveryMethod deliveryMethod, String payload) {
    ...
    // 생성 메서드
    public static Outbox create(AggregateType aggregateType, Long aggregateId, EventType eventType, OutboxDeliveryMethod deliveryMethod, String payload) {
