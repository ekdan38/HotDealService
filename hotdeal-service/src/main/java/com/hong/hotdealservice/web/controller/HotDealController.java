...
public class HotDealController {
    ...
    public ResponseEntity<?> createHotDeal(@RequestHeader("X-User-Id") Long adminId,
                                           @RequestBody @Validated HotDealCreateRequestDto requestDto,
        ...
        // 응답 설정
        ResponseDto<HotDealResponseDto> responseDto = new ResponseDto<>("핫딜 생성 성공", resultDto);
    ...
    public ResponseEntity<?> updateHotDeal(@PathVariable("hotDealId") Long hotDealId,
        ...
        // 응답 설정
        ResponseDto<HotDealResponseDto> responseDto = new ResponseDto<>("핫딜 수정 성공", resultDto);
        return ResponseEntity.ok().body(responseDto);
    ...
    public ResponseEntity<ResponseDto<HotDealResponseDto>> deleteHotDeal(@PathVariable("hotDealId") Long hotDealId) {
        ...
        // 응답 설정
        ResponseDto<HotDealResponseDto> responseDto = new ResponseDto<>("핫딜 삭제 성공", resultDto);
        return ResponseEntity.ok().body(responseDto);
    }
