...
import com.hong.orderservice.event.ExternalServiceInvoker;
import com.hong.orderservice.event.KafkaMessageProducer;
        ...
        for (Outbox outbox : foundOutboxes) {
            ...
            if(!isAborted){
                ...
                if(deliveryMethod.equals(OutboxDeliveryMethod.FEIGN)){
                    ...
                    externalServiceInvoker.invokeFeignService(new OutboxEvent(outbox));
                }
                // Kafka
